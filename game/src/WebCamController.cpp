...
void WebCamController::RGBtoHSV( float r, float g, float b, float *h, float *s, float *v )
{
	float min, max, delta;
	min = min3( r, g, b );
	max = max3( r, g, b );
...
void WebCamController::drawCross(IplImage *frame, int x, int y, int size, int width)
{
